...
public abstract class AbstractHttpClient {
     ...
     * @param baseUrl
     */
    protected AbstractHttpClient(final String baseUrl) {
     ...
     */
    public AbstractHttpClient(final String baseUrl, final RequestHandler requestHandler) {
     ...
     */
    public HttpResponse head(final String path, final ParameterMap params) {
     ...
     * @return Response object
     */
    public HttpResponse get(final String path, final ParameterMap params) {
     ...
     * @return Response object
     */
    public HttpResponse post(final String path, final ParameterMap params) {
     ...
     * @return Response object
     */
    public HttpResponse post(final String path, final String contentType, final byte[] data) {
     ...
     * @return Response object
     */
    public HttpResponse put(final String path, final String contentType, final byte[] data) {
     ...
     * @return Response object
     */
    public HttpResponse delete(final String path, final ParameterMap params) {
    ...
    protected HttpResponse doHttpMethod(final String path, final HttpRESTMethod httpMethod, final String contentType, final byte[] content) throws HttpRequestException {
     ...
     * @throws IOException
     */
    protected HttpURLConnection openConnection(final String path) throws IOException {
    ...
    protected void prepareConnection(final HttpURLConnection urlConnection, final HttpRESTMethod httpMethod, final String contentType) throws IOException {
     ...
     * @param urlConnection
     */
    private void appendRequestHeaders(final HttpURLConnection urlConnection) {
     ...
     *             NPEs also
     */
    protected int writeOutputStream(final HttpURLConnection urlConnection, final byte[] content) throws Exception {
     ...
     * @throws Exception
     */
    protected HttpResponse readInputStream(final HttpURLConnection urlConnection) throws Exception {
        InputStream in = null;
     ...
     * after {@link #prepareConnection(HttpURLConnection, HttpRESTMethod, String)},
     ...
     */
    public AbstractHttpClient addHeader(final String name, final String value) {
     ...
     * @param logger
     */
    public void setRequestLogger(final RequestLogger logger) {
    ...
    /**
     * Flush the cookies store.
     */
    public static void flushCookieManager() {
        CookieHandler.setDefault(new CookieManager());
    }
     ...
     */
    protected boolean isTimeoutException(final Throwable t, final long startTime) {
